...
const getPostsFromMeili = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { searchTerm, limit } = req.query;
    const numberLimit = Number(limit) || 10;
    const result = yield meilisearch_services_1.MeilisearchServices.getAllPosts(
    // Updated 'getAllItems' to 'getAllPosts'
    numberLimit, searchTerm);
