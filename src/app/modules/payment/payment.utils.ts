...
export const initiatePayment = async (paymentData: any) => {
  try {
    const response = await axios.post(process.env.PAYMENT_URL!, {
      ...
      success_url: `https://wayfarer-world-server.vercel.app/api/payment/confirmation?tran_id=${paymentData.tran_id}&status=success`,
      fail_url: `https://wayfarer-world-server.vercel.app/payment/confirmation?status=failed`,
      cancel_url: "https://wayfarer-world-server.vercel.app",
